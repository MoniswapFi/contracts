...
contract FactoryRegistry is IFactoryRegistry, Ownable {
  ...
  function approve(
    ...
    if (poolFactory == address(0) || votingRewardsFactory == address(0) || gaugeFactory == address(0)) revert ZeroAddress();
  ...
  /// @inheritdoc IFactoryRegistry
  function factoriesToPoolFactory(address poolFactory) public view returns (address votingRewardsFactory, address gaugeFactory) {
