...
import { AggregatorRouter, BexAdapter } from "../artifacts/types";
...
async function main() {
  ...
  const bexAdapter = await deploy<BexAdapter>("BexAdapter", undefined, constants.bexAdapter.factory, 215000, constants.bexAdapter.oracle);
